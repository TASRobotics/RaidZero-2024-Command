...
public class LimelightHelper {
    ...
    private static RawFiducial[] getRawFiducials(String limelightName) {
        var entry = LimelightHelper.getLimelightNTTableEntry(limelightName, "rawfiducials");
    ...
    public static RawDetection[] getRawDetections(String limelightName) {
        var entry = LimelightHelper.getLimelightNTTableEntry(limelightName, "rawdetections");
