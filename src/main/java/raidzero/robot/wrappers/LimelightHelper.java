...
public class LimelightHelper extends SubsystemBase {
    ...
    private static Pose3d toPose3D(double[] inData) {
        ...
        return new Pose3d(
                ...
                new Rotation3d(Conversions.degreesToRadians(inData[3]), Conversions.degreesToRadians(inData[4]),
                        Conversions.degreesToRadians(inData[5])));
    }
    ...
    private static Pose2d toPose2D(double[] inData) {
        ...
        Rotation2d r2d = new Rotation2d(Conversions.degreesToRadians(inData[5]));
